...
public class AdminStayWriteOkAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(stay_file1 != null) {
            ...
            String stay_file1_rename = stay_name + "_" + System.currentTimeMillis() + "." + fileExt;
        ...
        if(stay_file2 != null) {
            ...
            String stay_file2_rename = stay_name + "_" + System.currentTimeMillis() + "." + fileExt;
        ...
        if(stay_file3 != null) {
            ...
            String stay_file3_rename = stay_name + "_" + System.currentTimeMillis() + "." + fileExt;
        ...
        if(stay_file4 != null) {
            ...
            String stay_file4_rename = stay_name + "_" + System.currentTimeMillis() + "." + fileExt;
        ...
        if(stay_file5 != null) {
            ...
            String stay_file5_rename = stay_name + "_" + System.currentTimeMillis() + "." + fileExt;
