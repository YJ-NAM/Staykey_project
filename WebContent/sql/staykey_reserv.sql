...
insert into staykey_reserv values(1, 'reserv', '221031-123456', 1, '테스트숙소1', 2, '테스트방1', 'test', '테스트', '010-1111-1111', 'test@test.com', '2022/10/18 12:00:00', '2022/10/20 12:00:00', 2, 150000, '바베큐 세팅', 20000, null, 0, null, 0, 2000, 168000, 2, 1, 0, 'N', '요청사항입력1
줄바꿈', sysdate);
insert into staykey_reserv values(2, 'cancel', '221031-654321', 2, '테스트숙소2', 1, '테스트방5', 'test2', '테스트2', '010-2222-2222', 'test2@test.com', '2022/10/30 12:00:00', '2022/10/31 12:00:00', 1, 70000, null, 0, null, 0, null, 0, 0, 70000, 2, 0, 0, 'Y', '요청사항입력2
줄바꿈', sysdate);
insert into staykey_reserv values(3, 'reserv', '221031-451236', 1, '테스트숙소1', 3, '테스트방3', 'test', '테스트', '010-1111-1111', 'test@test.com', '2022/11/05 12:00:00', '2022/11/06 12:00:00', 1, 90000, '풍선 이벤트', 50000, null, 0, null, 0, 0, 140000, 2, 0, 0, 'N', '요청사항입력3
줄바꿈', sysdate);
