...
줄바꿈', sysdate);
insert into staykey_reserv values(3, 'reserv', '221031-451236', 3, '테스트숙소1', 1, '테스트방3', 'test', '테스트', '010-1111-1111', 'test@test.com', '2022/11/05 12:00:00', '2022/11/06 12:00:00', 1, 90000, '풍선 이벤트', 50000, null, 0, null, 0, 0, 140000, 2, 0, 0, 'N', '요청사항입력3
줄바꿈', sysdate);
