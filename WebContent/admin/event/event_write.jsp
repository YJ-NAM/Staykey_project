...
<div class="pb100">
	<form name="write_form" method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/admin/eventWriteOk.do">
		<input type="hidden" name="ev_writer_name" value="${login_name}" />
		<input type="hidden" name="ev_writer_id" value="${login_id}" />
		<input type="hidden" name="ev_writer_pw" value="${login_pw}" />
