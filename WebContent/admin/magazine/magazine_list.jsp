    ...
    <table class="table-list hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<%=request.getContextPath()%>/admin/magazineView.do?id=${dto.getMember_id()}">
                        <c:choose>
                ...
                <td>
                    <a href="<%=request.getContextPath()%>/admin/magazineModify.do?id=${dto.getMember_id()}" class="btn btn-sm btn-outline-primary m-1">수정</a>
                    <a href="<%=request.getContextPath()%>/admin/magazineDeleteOk.do?id=${dto.getMember_id()}" class="btn btn-sm btn-outline-danger m-1" onclick="return confirm('정말 삭제하시겠습니까?');">삭제</a>
                </td>
            </tr>
            </c:forEach>
            </c:when>
            ...
            <c:otherwise>
            <tr>
                <td colspan="10" class="nodata">등록된 매거진이 없습니다.</td>
            </tr>
            </c:otherwise>
            </c:choose>
        </tbody>
