    ...
    <!-------- 메인 페이지 비주얼 창 --------->
        <div id="main-visual parallax-bg" data-swiper-parallax="-23%" class="main-visual">
            ...
            <ul class= "swiper-wrapper">
                <li class="swiper-slide parallax-bg-1 slider-box" ><a href="#"><img class="img" src="asset/images/leegunhee.jpeg">
                    <div class="stay-info">
                        <p class="logo"></p>
                ...
                <li class="swiper-slide parallax-bg-2 slider-box"><a href="#"><img class="img" src="asset/images/whanki.jpeg">
                    <div id="stay-info">
                    <p class="logo"></p>
                ...
                <li class="swiper-slide parallax-bg-3 slider-box"><a href="#"><img class="" src="">
                    <div id="stay-info">
                    <p class="logo"></p>
                    <p class="title"></p>
                ...
                <li class="swiper-slide parallax-bg-4 slider-box"><a href="#"><img class="" src="">
                    <div id="stay-info">
                    <p class="logo"></p>
                    <p class="title"></p>
